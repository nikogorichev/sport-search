...
const initialState = { events: [], sports:[], places:[], participants:[] }

export const eventsReducer = (state = initialState, action) => {
  switch (action.type) {

    case INIT_EVENTS:
      return { ...state, events: action.payload.events, sports: action.payload.sports, places: action.payload.places, participants: action.payload.participants }
    ...
    case ADD_PARTICIPANT:
      ...
      return {
        ...state, participants: state.participants.filter(el => el.EventId !== action.payload.event_id)
      }
